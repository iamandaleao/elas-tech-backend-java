...
public class Data {
    public static void main(String[] args) {
        /*
         ...
         ZoneDateTime: Representa uma data e hora com informações de fuso horário.
         Period: Representa um periodo de tempo entre duas datas, com precisão de dias. meses e anos.
        ...
        do evento ocorre antes ou depois de uma data específica, como a data de hoje.
